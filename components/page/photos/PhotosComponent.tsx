            ...
            {photos?.map((photo) => (
                ...
                >
                    ...
                    <img
                        src={photo.url}
                        alt={`Photo ${photo.id}`}
                        className="relative z-10 w-full object-cover transition-all duration-300 group-hover:blur-sm group-hover:scale-105 group-active:blur-sm group-active:scale-105"
                    />
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity duration-300">
                        <span className="z-10 bg-white/40 dark:bg-black/40 rounded-sm p-2 text-sm font-medium drop-shadow-lg">
